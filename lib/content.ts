export const sectionContent = {
  ...
  about: {
    paragraphs: [
      ...
      "Right now I'm open to SRE, reliability-focused Solutions Architect, and focused freelance observability work. Jakarta based. Open to remote and relocation.",
    ],
  },
  experience: {
